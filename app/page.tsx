    ...
    <div className="flex min-h-screen flex-col bg-slate-200 text-slate-800 font-sans selection:bg-cyan-400 selection:text-white">
      ...
      <section className="relative flex min-h-[90vh] flex-col items-center justify-center overflow-hidden p-6 text-center">
             ...
             <div className="flex w-full overflow-hidden">
               <div className="flex animate-marquee whitespace-nowrap min-w-full flex-shrink-0">
                 {[...topRow, ...topRow, ...topRow].map((item, index) => (
                   <div key={`t1-${index}`} className="relative mx-4 h-48 w-80 flex-shrink-0 overflow-hidden bg-slate-200" style={techPanelStyle}>
               ...
               <div className="flex animate-marquee whitespace-nowrap min-w-full flex-shrink-0">
                 {[...topRow, ...topRow, ...topRow].map((item, index) => (
                   <div key={`t2-${index}`} className="relative mx-4 h-48 w-80 flex-shrink-0 overflow-hidden bg-slate-200" style={techPanelStyle}>
                     <Image src={item.image} alt={item.title} fill className="object-cover grayscale opacity-70" />
                   </div>
                 ))}
               </div>
             ...
             <div className="flex w-full overflow-hidden">
               <div className="flex animate-marquee whitespace-nowrap min-w-full flex-shrink-0" style={{ animationDuration: '45s' }}>
                 {[...bottomRow, ...bottomRow, ...bottomRow].map((item, index) => (
                   <div key={`b1-${index}`} className="relative mx-4 h-48 w-80 flex-shrink-0 overflow-hidden bg-slate-200" style={techPanelStyle}>
                     <Image src={item.image} alt={item.title} fill className="object-cover grayscale opacity-70" />
                   </div>
                 ))}
               </div>
               <div className="flex animate-marquee whitespace-nowrap min-w-full flex-shrink-0" style={{ animationDuration: '45s' }}>
                 {[...bottomRow, ...bottomRow, ...bottomRow].map((item, index) => (
                   <div key={`b2-${index}`} className="relative mx-4 h-48 w-80 flex-shrink-0 overflow-hidden bg-slate-200" style={techPanelStyle}>
                     <Image src={item.image} alt={item.title} fill className="object-cover grayscale opacity-70" />
                   </div>
                 ))}
               </div>
        ...
        <motion.div 
          ...
          className="relative z-10 max-w-4xl bg-white/80 backdrop-blur-md p-10 border-2 border-slate-200 shadow-[0_0_30px_rgba(34,211,238,0.2)]"
        ...
        >
          ...
          <p className="mb-10 text-lg leading-relaxed text-slate-600 max-w-2xl mx-auto">
            Building immersive experiences with <span className="font-bold text-slate-900">Unity (C#), UE5 (Blueprints), GameMaker Studio</span> & <span className="font-bold text-slate-900">RPG Maker</span>.<br />
          ...
          >
            ...
            <motion.a 
              ...
              className="bg-cyan-500 px-8 py-4 font-bold uppercase tracking-widest text-white transition-all hover:bg-cyan-400"
            >
              Database of Games
            </motion.a>
            ...
            <motion.a 
              ...
              style={techButtonStyle}
              className="flex items-center gap-3 border-2 border-slate-300 bg-white px-8 py-4 font-bold uppercase tracking-widest text-slate-700 transition-colors"
            >
             ...
             <motion.a 
              ...
              style={techButtonStyle}
              className="flex items-center border-2 border-slate-300 bg-white px-8 py-4 font-bold uppercase tracking-widest text-slate-700 transition-colors"
            >
              Contact
            </motion.a>
          </motion.div>
      ...
      <section className="container mx-auto px-6 py-24 overflow-hidden relative z-10 space-y-32">
        ...
        >
          <div className="flex-1">
             ...
             {/* TEXT PLATE */}
             <div className="bg-white p-8 border-l-4 border-orange-500 shadow-lg relative" style={techPanelStyle}>
                <h3 className="mb-4 text-4xl font-black uppercase text-slate-800">Origins</h3>
          ...
          {/* Tech Card */}
          <div className="flex-1 bg-white p-8 border border-slate-200 shadow-lg relative" style={techPanelStyle}>
             <div className="space-y-4">
                <div className="flex items-center justify-between border-b border-slate-100 pb-2">
                   <span className="font-mono text-sm text-slate-400">MODULE_01</span>
                   <span className="font-bold text-slate-800">Graphic Design</span>
                </div>
                <div className="flex items-center justify-between border-b border-slate-100 pb-2">
                   <span className="font-mono text-sm text-slate-400">MODULE_02</span>
                   <span className="font-bold text-slate-800">Computer Eng.</span>
                </div>
                <div className="flex items-center justify-between">
                   <span className="font-mono text-sm text-orange-500">CURRENT</span>
                   <span className="font-black text-slate-900 bg-orange-100 px-2">GAME DESIGN</span>
                </div>
             </div>
          </div>
        </motion.div>
        ...
        <motion.div 
          ...
          viewport={{ once: true, margin: "-100px" }}
          transition={{ duration: 0.7 }}
          className="flex flex-col gap-10 md:flex-row-reverse md:items-center"
        >
          <div className="flex-1 text-right md:text-left">
             ...
             {/* TEXT PLATE */}
             <div className="bg-white p-8 border-l-4 border-cyan-500 shadow-lg relative" style={techPanelStyle}>
               <h3 className="mb-4 text-4xl font-black uppercase text-slate-800">Legacy</h3>
               <p className="text-lg leading-relaxed text-slate-600">
          ...
          <div className="flex-1 bg-white p-8 border border-slate-200 shadow-lg" style={techPanelStyle}>
             <div className="text-center">
               <span className="block text-5xl font-black text-cyan-500 mb-2 drop-shadow-sm">Industry Rising Star</span>
               <span className="text-sm font-mono uppercase tracking-widest text-slate-400">Journalism, Game Jams & Internships</span>
             </div>
          </div>
        </motion.div>
        ...
        >
           <div className="flex-1">
             ...
             {/* TEXT PLATE */}
             <div className="bg-white p-8 border-l-4 border-red-500 shadow-lg relative" style={techPanelStyle}>
               <h3 className="mb-4 text-4xl font-black uppercase text-slate-800">Active Task</h3>
               <p className="text-lg leading-relaxed text-slate-600">
          ...
          <div className="flex-1 bg-white p-8 border border-slate-200 shadow-lg flex items-center justify-center relative overflow-hidden" style={techPanelStyle}>
             {/* Scanline effect */}
             ...
             <div className="text-center z-10">
                <div className="text-3xl font-black text-red-500 mb-1 tracking-widest">HONOR GAMES</div>
        ...
        >
          <div className="flex-1">
             ...
             {/* TEXT PLATE */}
             <div className="bg-white p-8 border-l-4 border-indigo-500 shadow-lg relative" style={techPanelStyle}>
               <h3 className="mb-4 text-4xl font-black uppercase text-slate-800">AI Logic</h3>
               <p className="text-lg leading-relaxed text-slate-600">
          ...
          <div className="flex-1 bg-zinc-900 p-8 border border-zinc-700 shadow-lg" style={techPanelStyle}>
        ...
        >
          <div className="flex-1">
             ...
             {/* TEXT PLATE */}
             <div className="bg-white p-8 border-l-4 border-teal-500 shadow-lg relative" style={techPanelStyle}>
               <h3 className="mb-4 text-4xl font-black uppercase text-slate-800">Fabrication</h3>
               <p className="text-lg leading-relaxed text-slate-600">
          ...
          <div className="flex-1 bg-white p-8 border border-slate-200 shadow-lg grid grid-cols-2 gap-4" style={techPanelStyle}>
             <div className="bg-slate-50 p-4 border border-slate-100 text-center">
                <span className="block text-xl font-bold text-slate-700">Blender</span>
                <span className="text-xs font-mono text-slate-400 uppercase">Modeling</span>
             </div>
             <div className="bg-slate-50 p-4 border border-slate-100 text-center">
                <span className="block text-xl font-bold text-slate-700">Cura</span>
        ...
        >
          <div className="flex-1">
             ...
             {/* TEXT PLATE */}
             <div className="bg-white p-8 border-l-4 border-blue-500 shadow-lg relative" style={techPanelStyle}>
               <h3 className="mb-4 text-4xl font-black uppercase text-slate-800">Stability</h3>
               <p className="text-lg leading-relaxed text-slate-600">
          ...
          <div className="flex-1 bg-slate-800 p-8 border border-slate-600 shadow-lg" style={techPanelStyle}>
        ...
        >
          <div className="flex-1">
             ...
             {/* TEXT PLATE */}
             <div className="bg-white p-8 border-l-4 border-purple-500 shadow-lg relative" style={techPanelStyle}>
               <h3 className="mb-4 text-4xl font-black uppercase text-slate-800">Full Stack</h3>
               <p className="text-lg leading-relaxed text-slate-600">
          ...
          <div className="flex-1 bg-white p-8 border border-slate-200 shadow-lg grid grid-cols-2 gap-4" style={techPanelStyle}>
             <div className="p-4 bg-slate-50 text-center border-l-2 border-purple-500"><span className="font-bold text-slate-700">Unity</span></div>
             <div className="p-4 bg-slate-50 text-center border-l-2 border-purple-500"><span className="font-bold text-slate-700">Source Control</span></div>
             <div className="p-4 bg-slate-50 text-center border-l-2 border-purple-500"><span className="font-bold text-slate-700">GraphicsGale</span></div>
             <div className="p-4 bg-slate-50 text-center border-l-2 border-purple-500"><span className="font-bold text-slate-700">Jira</span></div>
          </div>
        </motion.div>
      ...
      {/* --- GAMES GRID SECTION --- */}
      <section id="games" className="container mx-auto max-w-6xl px-6 py-24 relative z-10">
        <div className="mb-12 flex items-center gap-4">
           <div className="h-[2px] w-12 bg-cyan-400"></div>
           <h2 className="text-3xl font-black uppercase tracking-widest text-slate-800">Project_Database</h2>
      ...
      {/* --- CONTACT SECTION --- */}
      <section id="contact" className="bg-slate-100 py-24 text-center relative z-10 border-t border-slate-200">
        <motion.div 
        ...
        >
          ...
          <h2 className="mb-6 text-3xl font-black uppercase text-slate-800">Establish Comms</h2>

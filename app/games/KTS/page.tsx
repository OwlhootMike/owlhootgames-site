      ...
      <main className="container mx-auto px-6 pb-24 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          >
            ...
            />
            <div className="absolute inset-0 bg-emerald-900/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-6">
               <span className="text-white font-medium drop-shadow-md">Event</span>
            </div>
          </motion.div>
          ...
          >
            ...
            />
            <div className="absolute inset-0 bg-emerald-900/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-6">
               <span className="text-white font-medium drop-shadow-md">Food</span>
            </div>
          </motion.div>
          ...
          >
            ...
            />
            <div className="absolute inset-0 bg-emerald-900/20 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end p-6">
               <span className="text-white font-medium drop-shadow-md">Travel</span>
            </div>
          </motion.div>
      ...
      <footer className="bg-emerald-50/50 border-t border-emerald-100 py-12">
        <div className="container mx-auto px-6 flex flex-col items-center">
          ...
          <div className="flex gap-6 mb-8">
            {/* Instagram */}
            <a href="https://www.instagram.com/thekevision" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-emerald-600 transition-colors" aria-label="Instagram">
            ...
            {/* YouTube */}
            <a href="https://www.youtube.com/channel/UCRglkWKAp14GcK6kcol3pyw?app=desktop&fbclid=PAb21jcAO7DTZleHRuA2FlbQIxMQBzcnRjBmFwcF9pZA81NjcwNjczNDMzNTI0MjcAAaf3KqbtJ1iQx7g_BdaL30mReCmp3E3PGS3PPW8RiRanR1KqhJbfuU-KOsyM6g_aem_UC_99nZOO5KmnkbQGL9t4g" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-emerald-600 transition-colors" aria-label="YouTube">
              <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24"><path d="M23.498 6.186a3.016 3.016 0 0 0-2.122-2.136C19.505 3.545 12 3.545 12 3.545s-7.505 0-9.377.505A3.017 3.017 0 0 0 .502 6.186C0 8.07 0 12 0 12s0 3.93.502 5.814a3.016 3.016 0 0 0 2.122 2.136c1.871.505 9.376.505 9.376.505s7.505 0 9.377-.505a3.015 3.015 0 0 0 2.122-2.136C24 15.93 24 12 24 12s0-3.93-.502-5.814zM9.545 15.568V8.432L15.818 12l-6.273 3.568z"/></svg>
            </a>

            {/* Facebook */}
            <a href="https://www.facebook.com/KevisionTV" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-emerald-600 transition-colors" aria-label="Facebook">
            ...
            {/* Threads */}
            <a href="https://www.threads.com/@thekevision" target="_blank" rel="noopener noreferrer" className="text-slate-400 hover:text-emerald-600 transition-colors" aria-label="Threads">
